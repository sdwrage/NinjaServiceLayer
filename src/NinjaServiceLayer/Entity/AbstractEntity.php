...
abstract class AbstractEntity
{
   ...
   * __get
   *
   * Allows getting of protected properties through a getter method.
   *
   * @throws InvalidArgumentException If the provided property to get doesn't exist.
   ...
   * __set
   *
   * Allows setting of protected properties through a setter method.
   *
   * @throws InvalidArgumentException If the provided property to set doesn't exist.
